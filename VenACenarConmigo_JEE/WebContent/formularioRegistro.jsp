<form action="RegistroServlet">
        <fieldset>
            ...
            <div class="form-group" id="telefono-group">
                ...
                <br>
                <input type="text" name="telefono" class="form-control" id="telefono" placeholder="introduce tu número de teléfono">
            </div>
            <div class="form-group" id="ciudad-group">
                <label for="ciudad">Ciudad de residencia</label>
                <br>
                <input type="text" name="ciudad" class="form-control" id="ciudad" placeholder="introduce tu ciudad de residencia">
            </div>

...
public class ActualizacionPerfilTest {
  ...
  @Test
  public void testActualizacionPerfil() throws Exception {
    ...
    driver.findElement(By.id("telefono")).sendKeys("626445223");
    ...
    driver.findElement(By.id("password")).sendKeys("javier");
    driver.findElement(By.id("btnSubmit")).click();
    driver.findElement(By.linkText("Editar Perfil")).click();
    driver.findElement(By.id("profesion")).click();
    driver.findElement(By.id("profesion")).click();
    driver.findElement(By.id("profesion")).clear();
    driver.findElement(By.id("profesion")).sendKeys("Estudiante de Humanidades y profesor particular");
    driver.findElement(By.id("btnSubmit")).click();
    assertEquals("Ocupación: Estudiante de Humanidades y profesor particular", driver.findElement(By.xpath("//div[@id='userInfo']/h3[4]")).getText());
    driver.findElement(By.linkText("Opciones de privacidad")).click();
    driver.findElement(By.id("mesigue1")).click();
    driver.findElement(By.id("btnSubmit")).click();
    driver.findElement(By.linkText("Cambiar contraseña")).click();
    ...
    driver.findElement(By.id("repPassword")).click();
    driver.findElement(By.id("repPassword")).clear();
    driver.findElement(By.id("repPassword")).sendKeys("javi");
    driver.findElement(By.id("btnSubmit")).click();
    driver.findElement(By.id("email")).click();
    driver.findElement(By.id("email")).clear();
    driver.findElement(By.id("email")).sendKeys("javier.g.s@gmail.com");
